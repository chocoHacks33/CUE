...
from cue_vision.pipeline import VisionPipeline
...
def test_the_emitted_payload_carries_the_declared_contract_version() -> None:
    ...
    assert emitted["visionContractVersion"] == fixture["visionContractVersion"]
    assert emitted["provenance"]["pipelineVersion"].startswith("cue-vision/")
